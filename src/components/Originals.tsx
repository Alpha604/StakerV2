...
export function Originals({ setView }: { setView: (view: any) => void }) {
  ...
  const games = [
    ...
    { 
      name: "BLACKJACK", players: "1 215", bg: "from-[#ef5350] to-[#c62828]", action: () => setView('blackjack'),
    ...
    {
      name: "KENO", players: "1 150", bg: "from-[#5e35b1] to-[#311b92]", action: () => setView('keno'),
    ...
    {
      name: "CHICKEN / MOLES", players: "920", bg: "from-[#f4511e] to-[#bf360c]", action: () => setView('chicken'),
    ...
    {
      name: "TOME OF LIFE", players: "105", bg: "from-[#8d6e63] to-[#4e342e]", action: () => setView('tome-of-life'),
    ...
    {
      name: "SLIDE", players: "84", bg: "from-[#ec407a] to-[#c2185b]", action: () => setView('slide'),
