        ...
        <div className="p-6 border-b border-border-subtle flex items-center justify-between bg-bg-panel/50 backdrop-blur-md sticky top-0">
          <div className="flex items-center gap-3">
             ...
             <div>
               ...
               <p className="text-xs text-text-secondary uppercase tracking-wider font-semibold">Tops Players by Balance</p>
             </div>
          </div>
        ...
        <div className="p-6 overflow-y-auto flex-1">
          {loading ? (
             ...
             <div className="flex flex-col gap-2">
                {users.map((u, i) => (
                   <div key={u.username} className="flex items-center justify-between bg-bg-inner border border-border-medium rounded-xl p-3 shadow-inner hover:border-border-subtle transition-colors">
                      <div className="flex items-center gap-4">
                         ...
                         <div className="flex flex-col">
                            <span className="font-bold text-white text-sm">{u.username || 'Utilisateur Anonyme'}</span>
