          ...
          <div className="max-w-3xl space-y-8">
            ...
            <div className="bg-white/5 p-6 rounded-2xl border border-white/10 mt-6 mb-6">
              <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
                ...
                <div className="flex items-center gap-3 bg-black/40 px-4 py-2 rounded-xl border border-gray-800 w-fit">
                  <span className="text-sm font-bold text-gray-300">Statut Global</span>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input 
                      type="checkbox" 
                      className="sr-only peer" 
