...
export function Dice() {
  ...
  const [rollResult, setRollResult] = useState<number | null>(50.0);
          ...
          <div className="flex-1 flex flex-col items-center justify-center relative">
            ...
            <div className="w-full max-w-2xl relative h-3 bg-bg-panel rounded-full overflow-hidden flex shadow-inner">
              <div
                ...
                style={{
                  width:
                    condition === "over" ? `${target}%` : `${100 - target}%`,
              ...
              <div
                ...
                style={{
                  width:
                    condition === "over" ? `${100 - target}%` : `${target}%`,
              ...
              {rollResult !== null && (
                <motion.div
                  ...
                  className={cn(
                    ...
                    lastWin === true
                      ? "text-[#00e676] drop-shadow-[0_0_15px_rgba(0,230,118,0.5)]"
                      : lastWin === false
                        ? "text-[#ed4163]"
                        : "text-white",
                  )}
            ...
            <div className="w-full max-w-2xl bg-[#213743] rounded-lg p-2 md:p-4 grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 mt-8">
              ...
              <div className="bg-[#0f172a] rounded p-2 flex flex-col">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="bg-[#2c4755] hover:bg-[#345464] p-1 rounded transition-colors text-white"
                  >
                    ↺
                  </button>
                  <input
              ...
              <div className="bg-[#0f172a] rounded p-2 border border-[#00e676]/30 flex flex-col">
                <span className="text-text-secondary text-xs font-semibold text-[#00e676]">
                  Gain potentiel
                </span>
                <input
                  type="text"
