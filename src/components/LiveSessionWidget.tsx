    ...
    >
      ...
      <div className="flex items-center justify-between p-3 border-b border-border-subtle bg-bg-base cursor-grab active:cursor-grabbing">
        <div className="flex items-center gap-2">
           ...
           <span className="text-white font-bold text-sm tracking-wide">Live Stats</span>
        </div>
               ...
               <div className="p-4 flex flex-col gap-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm border-b border-border-subtle pb-3">
                     <div className="flex flex-col">
                        <span className="text-xs text-text-secondary uppercase tracking-wider font-semibold">Total Paris</span>
                        <span className="text-white font-mono font-medium">{totalWagered.toFixed(2)}$</span>
                     </div>
                     <div className="flex flex-col items-end">
                        <span className="text-xs text-text-secondary uppercase tracking-wider font-semibold">Total Gains</span>
                        <span className="text-white font-mono font-medium">{totalPayout.toFixed(2)}$</span>
                     </div>
                  </div>

                  <div className="flex justify-between items-end">
                     <span className="text-sm font-bold text-text-secondary uppercase tracking-wider">Bénéfice Net</span>
